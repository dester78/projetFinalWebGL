...
var camera, scene, renderer, waterObj;
var geometry, material, mesh,count;
var objects = [];
var raycaster;
...
function init() {
    ...
    var waterGeo = new THREE.PlaneGeometry(150, 150, 100, 100);
    ...
    waterGeo.vertices.map(function (vertex) {
    ...
    waterObj = new THREE.Mesh(waterGeo, waterMat);
    ...
    if ( controlsEnabled ) {
        ...
        for (var ix = 0; ix < 100; ix++) {
            for (var iy = 0; iy < 100; iy++) {
                waterObj.geometry.vertices[i++].z =
